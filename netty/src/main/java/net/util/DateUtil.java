...
public class DateUtil {  
	 ...
	 * @return
	 */
	public static String getStringTime(int year, int month, int day, int hour, int minute, int second) {
	...
	public static byte[] getbyteFromString(String time) {
		java.text.SimpleDateFormat format = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		Date date1 = null;
		try {
		...
		byte[] timeB = {(byte) yearLast,(byte) month,(byte) day,(byte) hour,(byte) minute};
		return timeB;
	}
