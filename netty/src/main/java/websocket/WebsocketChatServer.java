...
public class WebsocketChatServer {
	...
	public void run() throws Exception{
		 ...
		 * 如何知道多少个线程已经被使用，如何映射到已经创建的Channel上都需要依赖于 EventLoopGroup 的实现，
		 * 并且可以通过构造函数来配置他们的关系。
		 */
		...
		try {
			 ...
			 * SimpleChatServerInitializer 继承自ChannelInitializer是一个特殊的处理类，他的目的是帮助使用者配置一个新的 Channel。
			...
			//等待服务器  socket 关闭
			System.out.println("Websocket starts listening at 8686");
