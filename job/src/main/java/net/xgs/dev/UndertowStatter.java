...
public class UndertowStatter implements Startter {
	...
	public void start() throws ServletException {
		String MYAPP = "/";
		DeploymentInfo di = Servlets.deployment().setClassLoader(JobStart.class.getClassLoader()).setDeploymentName("app.war").setContextPath(MYAPP);
