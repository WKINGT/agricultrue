...
function(e) {
    ...
    return t.prototype = {
        ...
        _buildShape: function() {
            ...
            h = {},
            V = 0,
            d = e.length; d > V; V++) if (e[V].type == m.CHART_TYPE_MAP && (e[V] = this.reformOption(e[V]), n = e[V].mapType, r[n] = r[n] || {},
            r[n][V] = !0, l[n] = l[n] || e[V].mapValuePrecision, this._scaleLimitMap[n] = this._scaleLimitMap[n] || {},
            ...
            e[V].nameMap && U.merge(this._nameMap[n], e[V].nameMap, !0), this._activeMapType[n] = !0, e[V].textFixed && U.merge(u, e[V].textFixed, !0), e[V].geoCoord && U.merge(y, e[V].geoCoord, !0), this._selectedMode[n] = this._selectedMode[n] || e[V].selectedMode, (null == this._hoverable[n] || this._hoverable[n]) && (this._hoverable[n] = e[V].hoverable), (null == this._clickable[n] || this._clickable[n]) && (this._clickable[n] = e[V].clickable), (null == this._showLegendSymbol[n] || this._showLegendSymbol[n]) && (this._showLegendSymbol[n] = e[V].showLegendSymbol), h[n] = h[n] || e[V].mapValueCalculation, t = e[V].name, this.selectedMap[t] = o ? o.isSelected(t) : !0, this.selectedMap[t])) {
                ...
                g = i.length; g > p; p++) {
                    ...
                    for (var b in i[p])"value" != b ? s[n][a][b] = i[p][b] : isNaN(i[p].value) || (null == s[n][a].value && (s[n][a].value = 0), s[n][a].value += i[p].value);
                    s[n][a].seriesIndex.push(V)
                }
            }
            this._mapDataRequireCounter = 0;
            for (var f in s) this._mapDataRequireCounter++;
            this._clearSelected(),
            0 === this._mapDataRequireCounter && (this.clear(), this.zr && this.zr.delShape(this.lastShapeList), this.lastShapeList = []);
            for (var f in s) {
                if (h[f] && "average" == h[f]) for (var g in s[f]) s[f][g].value = (s[f][g].value / s[f][g].seriesIndex.length).toFixed(l[f]) - 0;
                this._mapDataMap[f] = this._mapDataMap[f] || {},
                this._mapDataMap[f].mapData ? this._mapDataCallback(f, s[f], r[f])(this._mapDataMap[f].mapData) : c[f.replace(/\|.*/, "")].getGeoJson && (this._specialArea[f] = c[f.replace(/\|.*/, "")].specialArea || this._specialArea[f], c[f.replace(/\|.*/, "")].getGeoJson(this._mapDataCallback(f, s[f], r[f])))
            }
        },
        _mapDataCallback: function(t, n, i) {
            var a = this;
            return function(o) {
                a._isAlive && null != a._activeMapType[t] && ( - 1 != t.indexOf("|") && (o = a._getSubMapData(t, o)), a._mapDataMap[t].mapData = o, o.firstChild ? (a._mapDataMap[t].rate = 1, a._mapDataMap[t].projection = e("../util/projection/svg")) : (a._mapDataMap[t].rate = .75, a._mapDataMap[t].projection = e("../util/projection/normal")), a._buildMap(t, a._getProjectionData(t, o, i), n, i), a._buildMark(t, i), --a._mapDataRequireCounter <= 0 && (a.addShapeList(), a.zr.refreshNextFrame()))
            }
        },
        ...
        _getProjectionData: function(e, t, n) {
            ...
            o = [],
            s = this._mapDataMap[e].bbox || a.getBbox(t, this._specialArea[e]);
            i = this._mapDataMap[e].hasRoam ? this._mapDataMap[e].transform: this._getTransform(s, n, this._mapDataMap[e].rate);
            var r, l = this._mapDataMap[e].lastTransform || {
                scale: {}
            };
            i.left != l.left || i.top != l.top || i.scale.x != l.scale.x || i.scale.y != l.scale.y ? (r = a.geoJson2Path(t, i, this._specialArea[e]), l = U.clone(i)) : (i = this._mapDataMap[e].transform, r = this._mapDataMap[e].pathArray),
            this._mapDataMap[e].bbox = s,
            this._mapDataMap[e].transform = i,
            this._mapDataMap[e].lastTransform = l,
            this._mapDataMap[e].pathArray = r;
            for (var h = [i.left, i.top], m = 0, V = r.length; V > m; m++) o.push(this._getSingleProvince(e, r[m], h));
        ...
        _getSingleProvince: function(e, t, n) {
            ...
            if (y[a]) i = this.geo2pos(e, y[a]);
                ...
                i = this.geo2pos(e, [s.left + s.width / 2, s.top + s.height / 2]),
                i[0] += o[0],
                i[1] += o[1]
            }
        ...
        _getTransform: function(e, t, n) {
            var i, a, o, s, r, l, h, m = this.series,
            V = this.zr.getWidth(),
            U = this.zr.getHeight(),
            ...
            a = isNaN(a) ? d: a,
            s = this.parsePercent(r, U),
            s = isNaN(s) ? d: s,
            l = null == l ? V - a - 2 * d: this.parsePercent(l, V),
            h = null == h ? U - s - 2 * d: this.parsePercent(h, U);
            var c = e.width,
            u = e.height,
            y = l / n / c,
            g = h / u;
        ...
        _buildMap: function(e, t, n, d) {
            ...
            I = t.length; I > w; w++) {
                ...
                c = k.name, u = n[c]) {
                    ...
                    p = "";
                    for (var v = 0,
                    J = u.seriesIndex.length; J > v; v++) g.push(W[u.seriesIndex[v]]),
                    p += W[u.seriesIndex[v]].name + " ",
                    X && this._showLegendSymbol[e] && X.hasColor(W[u.seriesIndex[v]].name) && this.shapeList.push(new o({
        ...
        _findMapTypeByPos: function(e, t) {
            var n, i, a, o, s;
            for (var r in this._mapDataMap) if (n = this._mapDataMap[r].transform, n && this._roamMap[r] && this._activeMapType[r] && (i = n.left, a = n.top, o = n.width, s = n.height, e >= i && i + o >= e && t >= a && a + s >= t)) return r
        },
        __onmousewheel: function(e) {
            if (! (this.shapeList.length <= 0)) {
                ...
                r = e.mapTypeControl;
                r || (r = {},
                n = this._findMapTypeByPos(a, o), n && this._roamMap[n] && "move" != this._roamMap[n] && (r[n] = !0));
                var l = !1;
                for (n in r) if (r[n]) {
                    l = !0;
                    ...
                    d = h.width,
                    c = h.height,
                    u = this.pos2geo(n, [a - V, o - U]);
                    if (s > 0) {
                        if (t = 1.2, null != this._scaleLimitMap[n].max && h.baseScale >= this._scaleLimitMap[n].max) continue
                    } else if (t = 1 / 1.2, null != this._scaleLimitMap[n].min && h.baseScale <= this._scaleLimitMap[n].min) continue;
                    h.baseScale *= t,
                    h.scale.x *= t,
                    h.scale.y *= t,
                    h.width = d * t,
                ...
                if (l) {
                    ...
                    this._refreshDelayTicket = setTimeout(function() {
                        b && b.shapeList && b.animationEffect()
                    },
                    100),
            ...
            if (! (this.shapeList.length <= 0)) {
                ...
                if (!t || !t.draggable) {
                    ...
                    if (o && this._roamMap[o] && "scale" != this._roamMap[o]) {
                        ...
                        var s = this;
                        setTimeout(function() {
                            s.zr.on(d.EVENT.MOUSEMOVE, s._onmousemove)
                        },
                        100)
                    }
                }
        ...
        __onmousemove: function(e) {
            if (this._mousedown && this._isAlive) {
                ...
                for (var o = 0,
                s = this.shapeList.length; s > o; o++) this.shapeList[o]._mapType == this._curMapType && (this.shapeList[o].position[0] = a.left, this.shapeList[o].position[1] = a.top, this.zr.modShape(this.shapeList[o].id));
                this.messageCenter.dispatch(m.EVENT.MAP_ROAM, e.event, {
                    type: "move"
                },
                this.myChart),
        ...
        __onroamcontroller: function(e) {
            ...
            var s, r;
            for (r in n) this._mapDataMap[r] && this._activeMapType[r] && (s = this._mapDataMap[r].transform, s.hasRoam = !0, s.left -= a, s.top -= i, this._mapDataMap[r].transform = s);
            for (var l = 0,
            h = this.shapeList.length; h > l; l++) r = this.shapeList[l]._mapType,
            n[r] && this._activeMapType[r] && (s = this._mapDataMap[r].transform, this.shapeList[l].position[0] = s.left, this.shapeList[l].position[1] = s.top, this.zr.modShape(this.shapeList[l].id));
            this.messageCenter.dispatch(m.EVENT.MAP_ROAM, e.event, {
                type: "move"
            },
            this.myChart),
        ...
        __ondrhoverlink: function(e) {
            ...
            this._hoverLinkMap[t] && this._activeMapType[t] && (n = V.get(this.shapeList[i], "value"), null != n && n >= e.valueMin && n <= e.valueMax && this.zr.addHoverShape(this.shapeList[i]))
        },
        onclick: function(e) {
            if (this.isClick && e.target && !this._justMove && "icon" != e.target.type) {
                ...
                if ("single" == this._selectedMode[a]) for (var o in this._selected) if (this._selected[o] && this._mapTypeMap[o] == a) {
                    for (var s = 0; i > s; s++) this.shapeList[s].style._name == o && this.shapeList[s]._mapType == a && (this.shapeList[s].style = this.shapeList[s]._style, this.zr.modShape(this.shapeList[s].id));
                    o != n && (this._selected[o] = !1)
                }
                this._selected[n] = !this._selected[n];
                for (var s = 0; i > s; s++) this.shapeList[s].style._name == n && this.shapeList[s]._mapType == a && (this.shapeList[s].style = this._selected[n] ? this.shapeList[s].highlightStyle: this.shapeList[s]._style, this.zr.modShape(this.shapeList[s].id));
                ...
                var r = this;
                setTimeout(function() {
                    r.zr.trigger(d.EVENT.MOUSEMOVE, e.event)
                },
                100)
            }
        },
...
function(e) {
    ...
    return r.prototype = {
        ...
        buildPathArray: function(e, t, n) {
            ...
            a = a.replace(/,,/g, ",");
            var s;
            for (s = 0; s < o.length; s++) a = a.replace(new RegExp(o[s], "g"), "|" + o[s]);
            var r = a.split("|"),
            l = [],
            h = 0,
            m = 0;
        ...
        _convertPoint: function(e, t, n, i, a, r, l, h, m) {
            var V = m * (Math.PI / 180),
        ...
        buildPath: function(e, t) {
            ...
            s = t.pointList = [], r = [], l = 0, h = o.length; h > l; l++) {
                "M" == o[l].command.toUpperCase() && (r.length > 0 && s.push(r), r = []);
                for (var m = o[l].points, V = 0, U = m.length; U > V; V += 2) r.push([m[V], m[V + 1]])
            }
            r.length > 0 && s.push(r);
            for (var l = 0,
            h = o.length; h > l; l++) {
        ...
        getRect: function(e) {
            ...
            s = e.x || 0,
            r = e.y || 0,
            l = e.pathArray || this.buildPathArray(e.path), h = 0; h < l.length; h++) for (var m = l[h].points, V = 0; V < m.length; V++) V % 2 === 0 ? (m[V] + s < n && (n = m[V]), m[V] + s > i && (i = m[V])) : (m[V] + r < a && (a = m[V]), m[V] + r > o && (o = m[V]));
            var U;
...
function(e) {
    ...
    return t.prototype = {
        ...
        _textGap: 10,
        _buildShape: function() {
            if (this._itemGroupLocation = this._getItemGroupLocation(), this._buildBackground(), this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable ? this._buildGradient() : this._buildItem(), this.dataRangeOption.show) for (var e = 0,
            t = this.shapeList.length; t > e; e++) this.zr.addShape(this.shapeList[e]);
            this._syncShapeFromRange()
        },
        _buildItem: function() {
            var e, t, n, o, s = this._valueTextList,
            r = s.length,
        ...
        _buildGradient: function() {
            ...
            U = 10,
            d = !0;
            this.dataRangeOption.text && (d = !1, this.dataRangeOption.text[0] && (n = this._getTextShape(s, r, this.dataRangeOption.text[0]), "horizontal" == this.dataRangeOption.orient ? s += h.getTextWidth(this.dataRangeOption.text[0], o) + this._textGap: (r += V + this._textGap, n.style.y += V / 2 + this._textGap, n.style.textBaseline = "bottom"), this.shapeList.push(new i(n))));
            ...
            "horizontal" == this.dataRangeOption.orient ? (t = {
                ...
                style: {
                    ...
                    width: l * U,
                    height: m,
                    color: p.getLinearGradient(s, r, s + l * U, r, u)
                },
                hoverable: !1
            },
            s += l * U + this._textGap) : (t = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {
                    x: s,
                    ...
                    width: l,
                    height: m * U,
                    color: p.getLinearGradient(s, r, s, r + m * U, u)
                },
                hoverable: !1
            },
            r += m * U + this._textGap),
            ...
            !d && this.dataRangeOption.text[1] && (n = this._getTextShape(s, r, this.dataRangeOption.text[1]), this.shapeList.push(new i(n)))
        },
        _buildIndicator: function() {
            ...
            r = 5;
            "horizontal" == this.dataRangeOption.orient ? "bottom" != this.dataRangeOption.y ? (e = [[n, i + s], [n - r, i + s + r], [n + r, i + s + r]], t = "bottom") : (e = [[n, i], [n - r, i - r], [n + r, i - r]], t = "top") : "right" != this.dataRangeOption.x ? (e = [[n + a, i], [n + a + r, i - r], [n + a + r, i + r]], t = "right") : (e = [[n, i], [n - r, i - r], [n - r, i + r]], t = "left"),
        ...
        _bulidHandle: function() {
            var e, t, n, i, a, s, r, l, m = this._calculableLocation.x,
            ...
            a = [[m + U, V], [m + U, V + d + c], [m + U + c, V + d + c], [m + U + 1, V + d], [m + U + 1, V]], s = m + U + u / 2 + c, r = n, l = {
                x: m + U,
                y: V + d,
                width: u + c,
                height: c
            ...
            a = [[m + U, V + d], [m + U, V - c], [m + U + c, V - c], [m + U + 1, V], [m + U + 1, V + d]], s = m + U + u / 2 + c, r = n, l = {
                x: m + U,
                y: V - c,
                width: u + c,
                height: c
            ...
            a = [[m, V + d], [m + U + c, V + d], [m + U + c, V + c + d], [m + U, V + 1 + d], [m, V + d + 1]], s = t, r = V + d + c / 2, l = {
                x: m + U,
                y: V + d,
                width: u + c,
                height: c
            ...
            a = [[m + U, V + d], [m - c, V + d], [m - c, V + c + d], [m, V + 1 + d], [m + U, V + d + 1]], s = t, r = V + d + c / 2, l = {
                x: m - u - c,
                y: V + d,
                width: u + c,
                height: c
        ...
        _getItemGroupLocation: function() {
            ...
            if ("horizontal" == this.dataRangeOption.orient) {
                if (this.dataRangeOption.text || this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable) o = (this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable ? i * m + n: t * (i + n)) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[0] ? h.getTextWidth(this.dataRangeOption.text[0], r) + this._textGap: 0) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[1] ? h.getTextWidth(this.dataRangeOption.text[1], r) + this._textGap: 0);
                else {
                    i += 5;
                    for (var V = 0; t > V; V++) o += i + h.getTextWidth(e[V], r) + n
                }
                o -= n,
                s = Math.max(l, a)
            } else {
                var U;
                if (this.dataRangeOption.text || this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable) s = (this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable ? a * m + n: t * (a + n)) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[0] ? this._textGap + l: 0) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[1] ? this._textGap + l: 0),
                U = Math.max(h.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[0] || "", r), h.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[1] || "", r)),
                o = Math.max(i, U);
                else {
                    s = (a + n) * t,
                    i += 5,
                    U = 0;
                    for (var V = 0; t > V; V++) U = Math.max(U, h.getTextWidth(e[V], r));
                    o = i + U
                }
                s -= n
            }
            ...
            case "top":
                ...
                break;
            case "bottom":
                u = y - s - p[2] - this.dataRangeOption.borderWidth;
                break;
            case "center":
                u = Math.floor((y - s) / 2);
                break;
            ...
            if (this.dataRangeOption.calculable) {
                ...
                "horizontal" == this.dataRangeOption.orient ? (g > d && (d = g), d + o + g > c && (d -= g)) : (l > u && (u = l), u + s + l > y && (u -= l))
            }
            return {
                x: d,
                y: u,
        ...
        __ondrift: function(e, t, n) {
            ...
            s = this._calculableLocation.height;
            return "horizontal" == this.dataRangeOption.orient ? e.style.x + t <= i ? e.style.x = i: e.style.x + t + e.style.width >= i + o ? e.style.x = i + o - e.style.width: e.style.x += t: e.style.y + n <= a ? e.style.y = a: e.style.y + n + e.style.height >= a + s ? e.style.y = a + s - e.style.height: e.style.y += n,
        ...
        _dispatchDataRange: function() {
            this.messageCenter.dispatch(s.EVENT.DATA_RANGE, null, {
                range: {
        ...
        __dataRangeSelected: function(e) {
            ...
            this.messageCenter.dispatch(s.EVENT.DATA_RANGE_SELECTED, e.event, {
        ...
        __dispatchHoverLink: function(e) {
            ...
            this.messageCenter.dispatch(s.EVENT.DATA_RANGE_HOVERLINK, e.event, {
                valueMin: t,
                valueMax: n
            },
            this.myChart)
        ...
        refresh: function(e) {
            if (e) {
                ...
                this._gap = ((this.dataRangeOption.max - this.dataRangeOption.min) / t).toFixed(s) - 0,
                this._valueTextList = [];
...
function(e) {
    ...
    return t.prototype = {
        ...
        _getScaleShape: function(e) {
            ...
            s = this._itemGroupLocation.y + this._itemGroupLocation.height - i,
            r = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {
        ...
        _dispatchEvent: function(e, t) {
            this.messageCenter.dispatch(s.EVENT.ROAMCONTROLLER, e, {
                roamType: t,
...
function(e) {
    function t(e) {
        ...
        i = 0; i < t.length; i++) for (var a = t[i], o = a.geometry.coordinates, s = a.geometry.encodeOffsets, r = 0; r < o.length; r++) {
            var l = o[r];
    ...
    var i = {
        ...
        "南海诸岛": {
            ...
            getPath: function(e, t) {
                for (var n = [[[0, 3.5], [7, 11.2], [15, 11.9], [30, 7], [42, .7], [52, .7], [56, 7.7], [59, .7], [64, .7], [64, 0], [5, 0], [0, 3.5]], [[13, 16.1], [19, 14.7], [16, 21.7], [11, 23.1], [13, 16.1]], [[12, 32.2], [14, 38.5], [15, 38.5], [13, 32.2], [12, 32.2]], [[16, 47.6], [12, 53.2], [13, 53.2], [18, 47.6], [16, 47.6]], [[6, 64.4], [8, 70], [9, 70], [8, 64.4], [6, 64.4]], [[23, 82.6], [29, 79.8], [30, 79.8], [25, 82.6], [23, 82.6]], [[37, 70.7], [43, 62.3], [44, 62.3], [39, 70.7], [37, 70.7]], [[48, 51.1], [51, 45.5], [53, 45.5], [50, 51.1], [48, 51.1]], [[51, 35], [51, 28.7], [53, 28.7], [53, 35], [51, 35]], [[52, 22.4], [55, 17.5], [56, 17.5], [53, 22.4], [52, 22.4]], [[58, 12.6], [62, 7], [63, 7], [60, 12.6], [58, 12.6]], [[0, 3.5], [0, 93.1], [64, 93.1], [64, 0], [63, 0], [63, 92.4], [1, 92.4], [1, 3.5], [0, 3.5]]], i = "", a = e[0], o = e[1], s = 0, r = n.length; r > s; s++) {
                    i += "M " + ((n[s][0][0] * t + a).toFixed(2) - 0) + " " + ((n[s][0][1] * t + o).toFixed(2) - 0) + " ";
                    for (var l = 1,
                    h = n[s].length; h > l; l++) i += "L " + ((n[s][l][0] * t + a).toFixed(2) - 0) + " " + ((n[s][l][1] * t + o).toFixed(2) - 0) + " "
                }
                return i + " Z"
            }
        },
...
function(e) {
    ...
    function i(e, t) {
        function n(e) {
            ...
            if (m[t]) {
                ...
                o.id = e.id, r(o, e), a.push(o))
            }
            for (var s = e.childNodes,
            l = 0,
            h = s.length; h > l; l++) n(s[l])
        }
    ...
    function l(e) {
        for (var t = s(e).replace(/,/g, " ").split(/\s+/), n = [], i = 0; i < t.length;) {
...
function() {
    ...
    function t(e, t) {
        ...
        o = 0,
        r = a.length; r > o; o++) if (i = a[o], !i.properties.name || !t[i.properties.name]) switch (i.type) {
        case "Feature":
        ...
        case "GeometryCollection":
            n = i.geometries;
            for (var l = 0,
            h = n.length; h > l; l++) s[n[l].type](n[l].coordinates)
        }
        return e.srcSize = {
